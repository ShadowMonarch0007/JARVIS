...
import PlusSvg from "@/components/assets/svg/PlusSvg";
...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute top-[55.25rem] left-10 right-10 h-[0.0625rem] bg-[#252134] pointer-events-none xl:block" />
  ...
  return (
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-[#CAC6DD]/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      ...
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        <div className="absolute bottom-1/2 left-1/2 w-[0.0625rem] h-1/2 origin-bottom rotate-[46deg]">
          <div
        ...
        <div className="absolute bottom-1/2 left-1/2 w-[0.0625rem] h-1/2 origin-bottom -rotate-[56deg]">
          <div
        ...
        <div className="absolute bottom-1/2 left-1/2 w-[0.0625rem] h-1/2 origin-bottom rotate-[54deg]">
          <div
        ...
        <div className="absolute bottom-1/2 left-1/2 w-[0.0625rem] h-1/2 origin-bottom -rotate-[65deg]">
          <div
        ...
        <div className="absolute bottom-1/2 left-1/2 w-[0.0625rem] h-1/2 origin-bottom -rotate-[85deg]">
          <div
        ...
        <div className="absolute bottom-1/2 left-1/2 w-[0.0625rem] h-1/2 origin-bottom rotate-[70deg]">
          <div
            className={`w-6 h-6 -ml-3 -mt-3 bg-gradient-to-b from-[#88E5BE] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
